    ...
    <div className="flex w-full h-full mt-28">
      <div className="w-1/6">
        <div className="flex flex-col items-center justify-center p-5">
          ...
          <p className="py-2 text-xl font-bold text-white">UserName</p>
        </div>
        <div className="flex flex-col items-center justify-center mx-10 mb-4 rounded-2xl bg-primary-light">
          <button>
            <img src={like} className="w-24 h-16 mt-4" />
          </button>
          <p className="my-5 font-bold">100</p>
        </div>
      </div>
      <div className="flex flex-col w-5/6">
        <div className="flex flex-row items-center justify-between px-4 pt-8">
          <div className="w-5/6">
            <p className="px-4 text-3xl font-semibold text-white break-words">
              Topic 1 อยากได้ คำพูด/คำคม กำลังใจ แบบตอนที่เหนื่อยมากๆ เหนื่อย ท้อ แบบไม่มีใครเข้าใจ
            </p>
          </div>
          <p className="px-4 text-white text-md">Post: 12/12/12</p>
        </div>
        <div className="p-4 pb-0">
          <div className="m-8 my-2 bg-primary-light rounded-3xl">
            <p className="p-4 text-lg break-words ">
              ...
              มันก็เป็นอุปสรรคเหมือนกันประมาณนี้ครับ บางทีเราจะรู้สึกว่าอุปสรรคต่างๆ อะไรพวกนี้
              มันต้องเป็นเรื่องยิ่งใหญ่ แต่จริงๆ แล้ว มันอาจจะเป็นเรื่องเล็กน้อยก็ได้
              มันก็เลยกลายมาเป็นความน่าสนใจของภาพยนตร์เรื่องนี้ด้วยครับ 🎬 ใน FAST & FEEL LOVE จะเป็นการนำเรื่อง
              ‘ความเร็ว’ มาเล่น แล้วในชีวิตจริงของพี่ ‘เต๋อ-นวพล’ มีไลฟ์สไตล์ที่รวดเร็วแบบในภาพยนตร์ไหม
            </p>
          </div>
        </div>
      </div>
